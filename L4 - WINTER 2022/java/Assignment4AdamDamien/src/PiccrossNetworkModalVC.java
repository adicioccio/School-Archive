...
public class PiccrossNetworkModalVC extends JDialog {
    ...
    **/
    ...
    public PiccrossNetworkModalVC  (JFrame mainView) {
        ...
        outerPanel.setBorder(BorderFactory.createMatteBorder(5,5,5,5,Color.gray));
    ...
    */
    ...
    private class Controller implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent evt)
        {
            ...
            if (flag && hasConnected) {
                PiccrossGame.disconnectItem.setEnabled(true);

                client = new Client(getAddress(), getPort(), getName());
                client.run();
