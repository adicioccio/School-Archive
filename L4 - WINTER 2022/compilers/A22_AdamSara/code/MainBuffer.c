...
abr_int isNumber(const abr_chr* ns);
abr_null startBuffer(abr_chr*, abr_chr*, abr_chr, abr_int, abr_int);
...
abr_int mainBuffer(abr_int argc, abr_chr** argv) {
	...
	abr_int isAnsiC = !ANSI_C;		/* ANSI C flag */
	abr_int size = 0, increment = 0, wrongNumber = 0;
...
************************************************************
*/
void startBuffer(abr_chr* program, abr_chr* input, abr_chr mode, abr_int size, abr_int increment) {

	BufferPointer bufferp;		/* pointer to Buffer structure */
	FILE* fileHandler;			/* input file handle */
	abr_int loadSize = 0;			/* the size of the file loaded in the buffer */
